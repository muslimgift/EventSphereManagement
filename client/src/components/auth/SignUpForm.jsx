...
const BASE_URL = import.meta.env.VITE_BACKEND_URL;
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { username, email, password, role, phonenumber, companyname } = formData;
if(isChecked!=true){
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                required
                  ...
                  className="w-full px-4 py-2 text-sm border rounded-lg bg-white dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-200"
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  I agree to the <span className="text-gray-800 dark:text-white">Terms</span> and <span className="text-gray-800 dark:text-white">Privacy Policy</span>
                </p>
              </div>
